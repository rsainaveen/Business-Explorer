    ...
    <div class="container">
      ...
      <div class="row marketing fix">
        <div class="col-lg-12">
         ...
         <ul class="list-group">
          <li class="list-group-item"><a href="/Struts2Starter/getTop10Business">Find yearly trends of your Business</a></li>
          <li class="list-group-item"><a href="/Struts2Starter/getTop10Cities">Find Location based trends of your Business</li>
        </ul>
